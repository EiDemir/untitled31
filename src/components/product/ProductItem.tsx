        ...
        <motion.div
            ...
            <div onMouseEnter={() => setIsHovered(true)}
                ...
                <Link prefetch={false} href={'/product/' + id}>
                    <Image className="rounded-md" src={imageLink} alt="Product's picture" width={1333}
                           height={2000}/>
                </Link>
                <motion.div
                    ...
                    <button className='transition ease-out duration-500 w-full hover:bg-black rounded-l-md'>ADD TO CARD
                    </button>
                    <button className='transition ease-out duration-500 w-full hover:bg-black rounded-r-md'>QUICK VIEW
                    </button>
                </motion.div>
            </div>
